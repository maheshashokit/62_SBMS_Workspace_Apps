...
public class CustomerController {
	...
	public void createNewCustomer(Customer customer) {
		...
		Customer createdCustomerData = customerService.creatingNewBrandCustomer(customer);

		if (Objects.nonNull(createdCustomerData)) {
			System.out.println("Customer Created SuccessFully.....");
			System.out.println(createdCustomerData);
		} else {
